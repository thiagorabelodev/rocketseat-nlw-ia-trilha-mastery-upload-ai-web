      ...
      <main className='flex-1 p-6 flex gap-6'> 
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <p className='text-sm text-muted-foreground'>
            Lembre-se: você pode utilizar a variável no seu prompt para adicionar o conteúdo da <code className='text-violet-400'>{'{transcrição}'}</code> do video selecionado.
          </p>
        </div>
